                        ...
                        <div class="card-body mb-5 mr-3">
                            <form method="POST"  action="{{ route('register') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <input id="first_name" type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" value="{{ old('first_name') }}" required placeholder="Imię" autocomplete="first_name" autofocus>
                                ...
                                <div class="row mt-lg-4">
                                    ...
                                    <div class="col-sm-4">
                                        <input id="nip" type="text" class="form-control @error('nip') is-invalid @enderror" name="nip" value="{{ old('nip') }}" placeholder="000 000 00 00" required autocomplete="nip" >
