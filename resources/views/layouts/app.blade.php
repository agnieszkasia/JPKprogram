...
<div class="bg2"></div>
    ...
    <div id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li>
                <div class="sidebar-brand">
                    <a href="{{ route('purchase_invoices') }}" class="sidebar-nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="white" class="bi bi-receipt" viewBox="0 0 18 18">
            ...
            <li>
                <div class="sidebar-brand">
                    <a href="{{ route('show_tax_settlements') }}" class="sidebar-nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="white" class="bi bi-calculator" viewBox="0 0 18 18">
