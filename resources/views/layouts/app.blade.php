            ...
            <ul class="sidebar-nav ">
                <li class="text-center mt-3 " >
                    ...
                    <a class="sidebar-nav-link h5" href="{{ route('profile') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="white" class="bi bi-people" viewBox="0 2 18 12">
...
{{--                            </svg>--}}
                        <br>
                        {{Auth::user()->first_name}} {{Auth::user()->family_name}}<br>{{ Auth::user()->company}}
                        <div class="h7">
                            NIP: {{Auth::user()->nip}}
                        </div>
                    </a>
