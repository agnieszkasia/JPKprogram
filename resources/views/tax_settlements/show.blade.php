...
@section('content')
    <div class="mt-5 h3 text-center ">ROZLICZENIE</div>
    <div class="mb-5">
                    ...
                    <table class="table table-borderless table-responsive">
                        ...
                        <tbody class="text-right h7">
                            ...
                            @for($i=0; $i<count($purchaseInvoicesData); $i++)
                                ...
                                <tr class="border-bottom">
                                    <td style="display:none;"><input name="purchase_invoice_ids[{{$i}}]" id="purchase_invoice_ids[{{$i}}]" value="{{$purchaseInvoicesData[$i]->id}}" hidden></td>
